module.exports = {
  ...
  contributing: "",
  confirmTests: true,
  tests: "Run the command `npm test` to generate a sample `README.md`. | You can change the test values by changing the values of the object in the `sample-answers.js` file, located in the `__test__` folder.",
  confirmRoadmap: true,
