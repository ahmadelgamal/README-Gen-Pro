module.exports = {
  ...
  description: "README Gen Pro is a command-line application that dynamically generates a professional `README.md` file from a user's input using the `inquirer.js` package. (This README file was generated using this app!)",
  confirmTOC: true,
  ...
  usage: "Go to the command line. | Navigate to the app directory. | Run `node index.js` (or `npm start`). | Answer the question prompts. | Once completed, check the `output` folder for the `README.md` file. | If you chose to add a gif animation/screenshot file, then either add it to a `./assets/images` folder in your app, or change the relative path in the `README.md` file.",
